...
class LatentDiffusion(DDPM):
    """main class"""
    def __init__(self,
                 first_stage_config, # "ldm.models.autoencoder.AutoencoderKL"
                 cond_stage_config, # "ldm.modules.encoders.modules.FrozenCLIPImageEmbedder"
                 num_timesteps_cond=None, # 1
                 cond_stage_key="image", # "image_cond"
                 cond_stage_trainable=False, # false
                 concat_mode=True,
                 cond_stage_forward=None,
                 conditioning_key=None, # "hybrid"
        ...
        assert self.num_timesteps_cond <= kwargs['timesteps'] # 1000
        ...
        self.unet_trainable = unet_trainable # True
        self.cond_stage_key = cond_stage_key # "image_cond"
        try:
        ...
        self.cc_projection = nn.Linear(771, 768)
